...
object HarmonicaNoteMap {
    private val frequencies = mapOf(
        ...
        HarmonicaNoteKey(5, true, false) to 523.25,
        HarmonicaNoteKey(5, false, false) to 587.33,
        HarmonicaNoteKey(5, true, true) to 554.37,
        HarmonicaNoteKey(5, false, true) to 622.25,
        HarmonicaNoteKey(6, true, false) to 659.25,
        HarmonicaNoteKey(6, false, false) to 698.46,
        HarmonicaNoteKey(6, true, true) to 698.46,
        HarmonicaNoteKey(6, false, true) to 739.99,
        HarmonicaNoteKey(7, true, false) to 783.99,
        HarmonicaNoteKey(7, false, false) to 880.00,
        HarmonicaNoteKey(7, true, true) to 830.61,
        HarmonicaNoteKey(7, false, true) to 932.33,
        HarmonicaNoteKey(8, true, false) to 1046.50,
        HarmonicaNoteKey(8, false, false) to 987.77,
        HarmonicaNoteKey(8, true, true) to 1108.73,
        HarmonicaNoteKey(8, false, true) to 1046.50,
        HarmonicaNoteKey(9, true, false) to 1046.50,
        HarmonicaNoteKey(9, false, false) to 1174.66,
        HarmonicaNoteKey(9, true, true) to 1108.73,
        HarmonicaNoteKey(9, false, true) to 1244.51,
        HarmonicaNoteKey(10, true, false) to 1318.51,
        HarmonicaNoteKey(10, false, false) to 1396.91,
        HarmonicaNoteKey(10, true, true) to 1396.91,
        HarmonicaNoteKey(10, false, true) to 1479.98,
        HarmonicaNoteKey(11, true, false) to 1567.98,
        HarmonicaNoteKey(11, false, false) to 1760.00,
        HarmonicaNoteKey(11, true, true) to 1661.22,
        HarmonicaNoteKey(11, false, true) to 1864.66,
        HarmonicaNoteKey(12, true, false) to 2093.00,
        HarmonicaNoteKey(12, false, false) to 1975.53,
        HarmonicaNoteKey(12, true, true) to 2217.46,
        HarmonicaNoteKey(12, false, true) to 2093.00
    )
